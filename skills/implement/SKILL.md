...
Implement the selected work as settled. For a task set, follow its blockers.
After an actual interruption, reconstruct progress from the spec, tasks, Git,
diff, and tests, then continue the remaining work. Do not absorb
...
blocking correctness, security, regression, or specification findings, rerun
affected checks, and have the reviewer recheck.
